      ...
      <div class="grid grid-cols-4 gap-x-8">
        ...
        >
          ...
          <div class="flex flex-col gap-y-1">
            <h3 class="font-bold text-xl">Extra Layers</h3>
            <p class="text-base text-gray-500 leading-relax">
              Making your project more<br />
              secure avoiding DDoS
            </p>
          </div>
          <a href="" class="text-base font-semibold text-violet-700">
            Learn More
          </a>
        </div>
        <div
        ...
        >
          ...
          <div class="flex flex-col gap-y-1">
            <h3 class="font-bold text-xl">Customizable</h3>
            <p class="text-base text-gray-500 leading-relax">
        ...
        <div
          class="relative my-card bg-[#080C2E] rounded-2xl px-5 py-8 flex flex-col gap-y-8"
        >
          <div class="z-10 flex flex-col gap-y-8">
            ...
            <div class="flex flex-col gap-y-1">
              <h3 class="font-bold text-xl text-white">AI Automation</h3>
              <p class="text-base text-[#8D90A8] leading-relax">
        ...
        >
          ...
          <div class="flex flex-col gap-y-1">
            <h3 class="font-bold text-xl">Auto-Scaling</h3>
            <p class="text-base text-gray-500 leading-relax">
