<template>
    <div id="faq">
        <section class="faq max-w-6xl mx-auto py-12">
      <div class="flex flex-col gap-y-8">
        ...
        <div class="grid grid-cols-2 gap-x-8">
          <div class="flex flex-col gap-y-6">
            <div
              class="card-fqa flex flex-row bg-white rounded-2xl p-5 gap-x-8 items-center justify-between"
            >
              <h3 class="font-bold text-xl">Why do we need to use Kapp?</h3>
              <a href="">
                <svg
                  width="31"
                  height="30"
                ...
                >
                  ...
                  <path
                    d="M21.44 12.7124L16.55 17.6024C15.9725 18.1799 15.0275 18.1799 14.45 17.6024L9.56 12.7124"
                    stroke="#080C2E"
                    stroke-width="2"
            ...
            <div
              class="card-fqa flex flex-row bg-white rounded-2xl p-5 gap-x-8 justify-between"
            >
              <div class="flex flex-col gap-y-5">
                ...
                <a href="" class="text-violet-700 text-base">Learn More</a>
              </div>
              <a href="">
                <svg
                  width="31"
          ...
          <div class="flex flex-col gap-y-6">
            ...
            <div
              class="card-fqa flex flex-row bg-indigo-950 rounded-2xl p-5 justify-between items-center"
            >
              <a href="" class="flex flex-row gap-x-1 text-white font-semibold">
                <svg
                  width="25"
                  height="24"
                  viewBox="0 0 25 24"
