    ...
    <section class="hero max-w-6xl mx-auto py-12">
      <div class="flex flex-col md:flex-row items-center justify-between">
        <div class="flex flex-col gap-y-10">
          <div
            class="small-badge bg-white flex flex-row rounded-full px-4 py-2 gap-x-2 w-fit"
          >
            <svg
              width="25"
              height="25"
            ...
            <p class="text-base text-indigo-950 font-semibold">
              We host more than 120,000 websites
            </p>
          </div>
          <div class="flex flex-col gap-y-4">
            <h1
              class="text-indigo-950 font-clash_display text-[70px] leading-none"
            >
              Grow Online<br />
              Business Faster.
            </h1>
          ...
          <div class="flex flex-row items-center gap-x-4">
            <a
              href=""
              class="bg-violet-700 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-indigo-950"
              >Try Free Trial</a
            >
            <a
              href=""
              class="flex flex-row gap-x-1 text-violet-700 font-semibold"
            >
              <svg
                width="25"
                height="24"
