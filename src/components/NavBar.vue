    ...
    >
      ...
      <ul class="hidden lg:flex flex-row gap-x-7 lg:mt-0">
        <li>
          <a
            href=""
            class="text-base text-indigo-950 hover:font-semibold hover:text-violet-700"
            >Products</a
          >
        </li>
        <li>
      ...
      <div class="hidden lg:flex flex-row items-center gap-x-3">
        ...
        <a
          href=""
          class="bg-indigo-950 text-white px-8 py-3 rounded-full font-semibold text-base hover:bg-violet-700"
          >Sign in</a
        >
      </div>
